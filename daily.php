<?php
	...
	$yourEmail	=	"youremail+ohjournal@gmail.com";			//the email you want to recieve your journal prompts to
	$saveEmail	=	"youremail+ohjournalresponse@gmail.com";	//the email you want to save your journal entries at
	...
	$headers	=	'From: OhJournal <ohjournal@petersobot.com>' . "\r\n" .	//may need to change this domain to yours if your emails won't send
   					'Reply-To: ' . $saveEmail . "\r\n" .
